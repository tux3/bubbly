...
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports PROBE_0]
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports PROBE_1]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports PROBE_2]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports PROBE_3]
set_property -dict {PACKAGE_PIN R12 IOSTANDARD LVCMOS33} [get_ports PROBE_4]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports PROBE_5]
...
# Completely placeholder timings, but hopefully around the right order of magnitude!
set_input_delay -clock [get_clocks FLASH_CLK] -min -add_delay -3.000 [get_ports FLASH_HOLD]
set_input_delay -clock [get_clocks FLASH_CLK] -max -add_delay 3.000 [get_ports FLASH_HOLD]
set_input_delay -clock [get_clocks FLASH_CLK] -min -add_delay -3.000 [get_ports FLASH_MISO]
set_input_delay -clock [get_clocks FLASH_CLK] -max -add_delay 3.000 [get_ports FLASH_MISO]
set_input_delay -clock [get_clocks FLASH_CLK] -min -add_delay -3.000 [get_ports FLASH_MOSI]
set_input_delay -clock [get_clocks FLASH_CLK] -max -add_delay 3.000 [get_ports FLASH_MOSI]
set_input_delay -clock [get_clocks FLASH_CLK] -min -add_delay -3.000 [get_ports FLASH_WP]
set_input_delay -clock [get_clocks FLASH_CLK] -max -add_delay 3.000 [get_ports FLASH_WP]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -min -add_delay -3.000 [get_ports FLASH_CS]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -max -add_delay 3.000 [get_ports FLASH_CS]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -min -add_delay -3.000 [get_ports FLASH_HOLD]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -max -add_delay 3.000 [get_ports FLASH_HOLD]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -min -add_delay -3.000 [get_ports FLASH_MISO]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -max -add_delay 3.000 [get_ports FLASH_MISO]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -min -add_delay -3.000 [get_ports FLASH_MOSI]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -max -add_delay 3.000 [get_ports FLASH_MOSI]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -min -add_delay -3.000 [get_ports FLASH_WP]
set_output_delay -clock [get_clocks FLASH_CLK] -clock_fall -max -add_delay 3.000 [get_ports FLASH_WP]
